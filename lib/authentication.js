...
exports.checkToken = function (req, res, next) {
    ...
    var pubKey = fs.readFileSync(svmp.config.get('settings:tls_certificate'));
...
exports.makeToken = function (userInfo) {
    var privKey = fs.readFileSync(svmp.config.get('settings:tls_private_key'));
    return jwt.sign(userInfo, privKey, {algorithm: svmp.config.get("settings:jwt_signing_alg")});
};
