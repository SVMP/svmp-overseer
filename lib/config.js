...
var Configuration = exports.Configuration = function () {
    ...
    this.mtimes = {};
    try {
        // Check for the config-local.  If it's not there,
        // we create in the 'catch' and tell the user
        // to fill it in
        ...
        var configStub = fs.readFileSync(__dirname + '/../config/_config.local.template.js');
        fs.writeFileSync(__dirname + '/../config/config-local.js', configStub);
...
Configuration.prototype.useTlsCertAuth = function () {
    return this.get("settings:use_tls") && this.get("settings:use_tls_user_auth");
};
...
Configuration.prototype.configTls = function () {
    if (this.isEnabled('settings:use_tls')) {
